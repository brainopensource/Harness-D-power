...
graph TD
    subgraph "Track 1: Execution Architecture (ADR-0013)"
        ...
        M1ap --> M2["M2: Memoization & Ablation Engine"]
    ...
    subgraph "Track 2: Measurement & Instrumentation (ADR-0002)"
        ...
        B4 --> AA["A/A Variance Floor<br/>(derived N, exact McNemar)"]
...
| **Milestone M1a++** | Inner Loop Context Lift (Auto-discovery, Repair Context Re-reading, Test assertion prompt injection) | [Sprint 3.5 Rationale](../rationale/sprint-3.5-inner-loop-improvements.md), [ADR-0010](../decisions/0010-context-prefix-layers.md), [ADR-0014](../decisions/0014-workflow-topology-is-data.md) | M1a+ | **Done** |
| **A/A Noise Floor** | Statistical Variance Baseline; **derives N for every later family** | [`measurement.md` §3](../measurement.md#3-the-aa-variance-floor), [ADR-0002](../decisions/0002-no-number-before-the-floor.md), [ADR-0003](../decisions/0003-statistical-admission-protocol.md) | B1, B2b, **B4**, B3 canary | 3 Days |
