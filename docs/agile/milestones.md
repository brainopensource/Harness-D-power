...
* **Exit Gate 4**: Worktree-creation and AST parse-and-validate timers recorded in [`docs/benchmarks/results/`](../benchmarks/results/README.md). These two numbers decide [ADR-0001](../decisions/0001-python-first-compiled-on-trigger.md)'s F1 fork.
