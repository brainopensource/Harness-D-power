...
* The **modular docs (`01` – `08`)** and [`implementation/`](./implementation/) are the **normative source of truth** for rationale, sequencing, and process. When a detail is contested, these win — except for contracts (below).
...
| 📁 [`implementation/`](./implementation/) | **Normative** | [**contracts-to-code.md**](./implementation/contracts-to-code.md), [development_plan_v2.md](./implementation/development_plan_v2.md) |
...
8. [Foundation Review](./reviews/doing/2026-07-29-foundation-review.md) — current audit of record until Sprint 3 closes.
