...
`run.started` carries the extension manifest because a trajectory that replays against a different extension set is not a replay. See [ADR-0013](../decisions/0013-workflow-dag-phased.md).
