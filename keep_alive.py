    ...
    for i in range(steps):
        try:
            ...
            if x11 and xtest and display:
                ...
                subprocess.run(["xdotool", "mousemove_relative", "--", str(dx), str(dy)], **quiet)
                subprocess.run(["xdotool", "key", "A"], **quiet)
