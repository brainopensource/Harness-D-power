...
- [x] **5.1 (D13)** Write `docs/08-decisions/0026-indexer-search-replaces-neighbors.md` per D1.
- [x] **5.2 (D13)** Write `docs/08-decisions/0027-fixed-chunk-size-policy.md` per D2.
- [x] **5.3 (M-7)** Replace "21 → 15" at `docs/implementation/development_plan_v2.md:19` and
...
- [x] **5.4 (M-6)** Tick the 18 delivered-but-unchecked epic boxes in `development_plan_v2.md`.
...
- [x] **5.5 (m-8)** Amend the S5 credential wording in `development_plan_v2.md` and
      ...
      as an S7 candidate.
- [x] **5.6 (m-9, per D5)** Add the `run_command`-under-taint rationale to
      ...
      change.**
- [x] **5.7 (D11)** Add the "no absolute `file://` links in `docs/`" rule to the docs conventions
      section (wherever `check_links.py`'s contract is described).
- [x] **5.8 (C-2)** Run `scripts/verify.sh`. Confirm **all seven gates green**. Save output to
      `docs/rationale/done/verify-W5-p0-complete.txt`.
- [x] **5.9 (C-2)** Replace the `docs/STATUS.md` "Frozen Regression Signals" table by **copying
...
- [x] **5.10 (m-13, per D4)** Record the withdrawal of m-13 in §5. No code change.
